...
export const dictionaries: Record<Language, Dictionary> = {
  ...
  es: {
    ...
    sidebar: {
      ...
      adminRole: 'Administrador de flota',
    },
    settingsNav: {
    ...
    pages: buildPages({
      ...
      '/app/admin/dashboard': ['Resumen', 'La flota de un vistazo'],
      '/app/admin/vehicles': ['Flota', 'Vehículos — la fuente de la verdad'],
      '/app/admin/drivers': ['Conductores', 'Plantilla, licencias y horas de trabajo'],
      '/app/admin/team': ['Equipo', 'Miembros del espacio de trabajo y roles'],
      '/app/admin/documents': ['Base de conocimiento', 'Documentos que alimentan al asistente'],
  ...
  fr: {
    ...
    sidebar: {
      ...
      adminRole: 'Administrateur de flotte',
    },
    settingsNav: {
      heading: 'Paramètres',
      account: 'Compte',
    ...
    pages: buildPages({
      ...
      '/app/admin/dashboard': ['Aperçu', "La flotte en un coup d'œil"],
      '/app/admin/vehicles': ['Flotte', 'Véhicules — la source de vérité'],
      '/app/admin/drivers': ['Chauffeurs', 'Effectif, permis et heures de travail'],
      '/app/admin/team': ['Équipe', "Membres de l'espace de travail et rôles"],
      '/app/admin/documents': ['Base de connaissances', "Documents alimentant l'assistant"],
  ...
  de: {
    ...
    sidebar: {
      ...
      adminRole: 'Flottenadministrator',
    },
    settingsNav: {
    ...
    pages: buildPages({
      ...
      '/app/admin/dashboard': ['Übersicht', 'Die Flotte auf einen Blick'],
      '/app/admin/vehicles': ['Flotte', 'Fahrzeuge — die maßgebliche Quelle'],
      '/app/admin/drivers': ['Fahrer', 'Personal, Führerscheine und Arbeitszeiten'],
      '/app/admin/team': ['Team', 'Mitglieder des Arbeitsbereichs und Rollen'],
      '/app/admin/documents': ['Wissensdatenbank', 'Dokumente für den Assistenten'],
  ...
  zh: {
    ...
    pages: buildPages({
      ...
      '/app/admin/dashboard': ['概览', '车队一览'],
      '/app/admin/vehicles': ['车队', '车辆——真实数据来源'],
      '/app/admin/drivers': ['司机', '名册、执照和工作时长'],
      '/app/admin/team': ['团队', '工作区成员和角色'],
      '/app/admin/documents': ['知识库', '为助手提供支持的文档'],
  ...
  pt: {
    ...
    sidebar: {
      ...
      adminRole: 'Administrador de frota',
    },
    settingsNav: {
    ...
    pages: buildPages({
      ...
      '/app/admin/dashboard': ['Visão geral', 'A frota em um relance'],
      '/app/admin/vehicles': ['Frota', 'Veículos — a fonte da verdade'],
      '/app/admin/drivers': ['Motoristas', 'Equipe, licenças e horas de trabalho'],
      '/app/admin/team': ['Equipe', 'Membros do espaço de trabalho e funções'],
      '/app/admin/documents': ['Base de conhecimento', 'Documentos que alimentam o assistente'],
